...
public class PayController {
    ...
    @ResponseBody
    public Object payStart(@RequestBody PayParam payParam){
        ...
        String out_trade_no = payParam.out_trade_no;
        //付款金额，必填
        String total_amount = payParam.total_amount;
        //订单名称，必填
        String subject = payParam.subject;
        //商品描述，可空
        String body = payParam.body;
        String result=null;
        try {
